    ...
    <div className={classes.main}>
      ...
      <div>
        <div className={classes.divsPosition}>
          ...
          <div className="pages">
            <button
              className={classes.buttonRedistrationAvatarka}
          ...
          <div>
            <button
              className={classes.buttonRedistration}
              onClick={() => {
                setModalActive(!islogin);
                setQuit();
                redirectHandler();
                dispatch(setClearReducer());
              }}
            >
              {islogin ? "Выйти" : "Зарегестрироватся"}
            </button>
          </div>
        </div>
