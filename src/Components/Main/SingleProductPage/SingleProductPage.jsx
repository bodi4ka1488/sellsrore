...
const SingleProductPage = () => {
  ...
  const { id } = useParams();
  const [setCurrentProd] = useState();
  // sp - single product
  useEffect(() => {
    getSingleProducts(id).then((json) => {
  ...
  return (
    <div className="singleProductWrapper">
      ...
      <div className="foroSP">
        <img
          className="fotoSP-img"
          src={`${currentProduct.image}`}
          alt={currentProduct.title}
        />
      </div>
      <div className="price-wrapper">
        <div className="descSP">
        ...
        <div className="priceSP">
          ...
          <CustomButton
            clickHandler={() =>
              dispatch(
                setAddMoreProducts(currentProduct.id, currentProduct.price)
              )
            }
          />
        </div>
